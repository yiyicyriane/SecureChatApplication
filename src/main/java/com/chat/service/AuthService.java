...
public class AuthService {
    private final String serverUrl = "http://54.193.233.72:8080/api/auth";
    ...
    public String putPassword(String userId, String password, String newPassword) throws Exception {
        String endpoint = serverUrl + "/password/" + userId + "?password=" + password;
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(endpoint))
